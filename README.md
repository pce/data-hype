...
- For cleaner and minimal footprint:
  - Hype Rx (with bundled RxJS) for observalbe pipeline and oprators, filter on straems
  - Hype with EventSystem
...
<form action="/api/submit" method="POST" data-hype-post="/api/submit" data-hype-target="#result">
